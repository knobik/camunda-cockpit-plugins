...
var BatchRetryConfirmationModal = function (_a) {
    ...
    return (React.createElement(ReactModal, { className: "modal-dialog batch-retry-modal", isOpen: showModal, style: {
            content: {},
            overlay: {
                zIndex: 2000,
            },
        ...
        React.createElement("div", { className: "modal-content", style: {
            ...
            React.createElement("div", { className: "modal-header" },
                React.createElement("h3", null, "Batch Increment Number of Retries")),
...
export { definitionBatchRetry as default };
